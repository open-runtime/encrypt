...
class Encrypted {
  ...
  Encrypted.fromUtf8(String input) : _bytes = Uint8List.fromList(convert.utf8.encode(input));
...
class IV extends Encrypted {
  ...
  IV.fromBase64(super.encoded) : super.fromBase64();
  ...
  /// Random.secure() generator.
  ///
  /// This creates a fresh random IV every time it is called. Persist the IV
  /// and reuse that same value for decryption.
  IV.fromLength(super.length) : super.fromLength();
  ...
  /// The key is ALL ZEROS - NOT CRYPTOGRAPHICALLY SECURE!
  IV.allZerosOfLength(super.length) : super.allZerosOfLength();
}
...
class Key extends Encrypted {
  ...
  /// The key is filled with [length] bytes generated by a
  /// Random.secure() generator
  Key.fromLength(super.length) : super.fromLength();
